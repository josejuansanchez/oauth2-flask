...
- `client_id=sOLra1TDVnbvI-o3bXUNVSmq`: Identificador único de la aplicación cliente.
- `redirect_uri=https://www.oauth.com/playground/authorization-code.html`: URL a la que el servidor de autorización redirigirá al usuario después de la autorización.
